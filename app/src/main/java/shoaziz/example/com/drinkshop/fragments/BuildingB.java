...
public class BuildingB extends Fragment {
    List<Menu> menus;
    MenuAdap menuAdap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_building_b, container, false);
        button = view.findViewById(R.id.reloadb3);

       // imageView = view.findViewById(R.id.img_iuta4);
        recyclerView = view.findViewById(R.id.recycler_in_frag3);
        recyclerView.setLayoutManager(new GridLayoutManager(getActivity(),2));
        progressBar = view.findViewById(R.id.progress_b3);
        return view;
    }
    @Override
    ...
    void json(){
        ...
        Call<List<Menu>> call = retroInterface.getMenu("Token ffe20ab28f326136d4f701d8aa8b48dba483fe4a","3");
